  ...
  <section class="container-fluid trip-info">
    <div class="same-height two-columns row">
        ...
        <div id="tour-slide">
          <div class="slide">
            <div class="bg-stretch">
              <img src="../assets/images/pacote/icon/{{$detalhes->icon}}" alt="image descriprion" height="1104" width="966" />
            </div>
          </div>
          <div class="slide">
            <div class="bg-stretch">
      ...
      <div class="height col-md-6 text-col">
        <div class="holder">
          <h1 class="small-size">{{ $detalhes->servicos->titulo }}</h1>
          <hr>
  ...
  <div class="tab-container">
      ...
      <div class="container">
        ...
        <ul class="nav nav-tabs text-center" role="tablist">
          <li role="presentation" class="active">
            <a href="#tab01" aria-controls="tab01" role="tab" data-toggle="tab">Visão geral</a>
          </li>
          <li role="presentation">
            <a href="#tab02" aria-controls="tab02" role="tab" data-toggle="tab">Itinerário</a>
          </li>
          <li role="presentation">
            <a href="#tab03" aria-controls="tab03" role="tab" data-toggle="tab">Acomodação</a>
          </li>
          <li role="presentation">
            <a href="#tab04" aria-controls="tab04" role="tab" data-toggle="tab">Perguntas frequentes &amp; Análise</a>
          </li>
          <li role="presentation">
            <a href="#tab05" aria-controls="tab05" role="tab" data-toggle="tab">Galeria</a>
          </li>
          <li role="presentation">
            <a href="#tab06" aria-controls="tab06" role="tab" data-toggle="tab">Datas &amp; Preços</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container tab-content trip-detail">
      ...
      <div role="tabpanel" class="tab-pane active" id="tab01">
        <div class="row">
          <div class="col-md-6">
            <strong class="header-box">Visão Geral</strong>
            <p>
              {{$detalhes->descricao}}
            </p>
          </div>
      ...
      <div role="tabpanel" class="tab-pane" id="tab05">
        <ul class="row gallery-list has-center">
          @foreach($pacote as $p)
          <li class="col-sm-6">
            <a class="fancybox" data-fancybox-group="group" href="#" title="Caption Goes Here">
