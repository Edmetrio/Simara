                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebarApps">
                                <ul class="nav-second-level">
                                    ...
                                    <li><a href="{{ route('destino.index') }}">Destino</a></li>
                                    <li><a href="{{ route('post.index') }}">Postagem</a></li>
                                    <li><a href="{{ route('pacote.index') }}">Pacote</a></li>
                                    <li><a href="{{ route('depoimento.index') }}">Depoimento</a></li>
                                    <li><a href="{{ route('companhia.index') }}">Companhia</a></li>
                                </ul>
                            </div>
                        </li>
